    ...
    try:
        ...
        return [
            APIKeyResponse(
                ...
                scopes=key.scopes if isinstance(key.scopes, list) else key.scopes.strip("{}").split(",") if key.scopes else [],
...
async def create_api_key(
    ...
    try:
            ...
            if not trading_account:
                ...
                if account_exists:
                    ...
                    try:
                        ...
                        print(f"Failed to link account: {link_error}")
                        db.rollback()
                        raise HTTPException(
        ...
        return APIKeyWithSecret(
            ...
            scopes=new_api_key.scopes if isinstance(new_api_key.scopes, list) else new_api_key.scopes.strip("{}").split(",") if new_api_key.scopes else [],
